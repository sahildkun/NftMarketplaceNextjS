...
// import logo1 from '../Images/binance-logo-icon.svg'
// import logo2 from '../Images/Metamask-logo.svg'
// import logo3 from '../Images/coinbase-logo-icon.svg'
// import img from '../Images/nft4.jpg'
// import img1 from '../Images/nft1.jpg'
// import img2 from '../Images/nft2.jpg'
// import img4 from '../Images/nft5.jpg'
// import img5 from '../Images/nft6.jpg'
// import img6 from '../Images/nft7.png'
// import img7 from '../Images/nft8.png'
// import img8 from '../Images/nft.png'
  ...
  return (
    <div className='flex flex-col-reverse md:flex-row items-center px-8 mx-auto space-y-0 md:space-y-0 h-screen bg-bgpic' id='nic'>
      ...
      <div className='flex flex-col pb-[6rem] space-y-8 md:w-1/2'>
        <h1 className='text-3xl text-white lg:text-6xl font-bold text-center lg:ml-12 lg:mt-7 md:text-3xl md:text-left' id='nic'>DISCOVER AND COLLECT NFTS THAT ARE<br></br><span className='text-[#f1b73b] wrap'>{text}</span></h1>
      ...
      <div className='md:w-1/2 items-center justify-center text-center text-white' id='nic'>
        <div className='right pt-28 md:pt-11'>
          ...
          <div className='card-group'>
            ...
            <img src={img} className='rounded-xl  h-full w-full border-2' alt=''/>
            </div>
            <div className='big cards'>
              <img src={img7} className='rounded-xl h-full w-full  border-2' alt=''/>
            </div>
            <div className='small cards'>
            <img src={img4} className='rounded-xl  h-full w-full border-2'alt=''/>
            </div>
            <div className='big cards'>
              <img src={img1} className='rounded-xl  h-full w-full  border-2'alt=''/>
            </div>
            <div className='small cards'>
            <img src={img8} className='rounded-xl  h-full w-full border-2'alt=''/>
            </div>
            <div className='big cards'>
              <img src={img2} className='rounded-xl  h-full w-full  border-2' alt=''/>
            </div>  
            <div className='small cards'>
            <img src={img5} className='rounded-xl  h-full w-full border-2'alt=''/>
            </div>
            <div className='big cards'>
             <img src={img6} className='rounded-xl  h-full w-full border-2' alt=''/>
            </div>    
        </div>
        </div>
      </div>
